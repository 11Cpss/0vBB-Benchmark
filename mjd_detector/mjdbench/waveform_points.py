"""Deterministic point tokens and Hilbert sequences for MJD waveforms."""
...
class WaveformPointTokenizer(nn.Module):
    """Convert one waveform into fixed-size point coordinates and features."""
...
def dual_hilbert_sequences(
    ...
    """Serialize points with the project's Hilbert and x/y Trans-Hilbert orders."""
