"""Paired MJD models using the frozen NEXT PointMamba-lite architecture."""
...
class PointMambaBackbone(nn.Module):
    """Shared pure-PyTorch selective SSM over two Hilbert waveform orders."""
...
class PointMamba(nn.Module):
    """Task head on the shared PointMamba-lite backbone."""
