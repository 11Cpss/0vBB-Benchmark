...
from supernemo_transformer import SuperNEMOTokenizationConfig
...
class TrainingConfig:
    """Frozen SuperNEMO optimization and execution settings."""
...
class ArchitectureConfig:
    ...
    tokenization: SuperNEMOTokenizationConfig | None = None
...
_COMMON_TRAINING = {
    ...
    "seed": DEFAULT_SEED,
    # Execution-only setting. Eight workers matches the completed NEXT
    # Transformer workflow and avoids reconstructing millions of events in the
    # notebook process. It is recorded in every run configuration/checkpoint.
    "num_workers": 8,
    "deterministic": False,
    "use_amp": True,
    "amp_precision": "auto",
...
_ENTITY_TOKENIZATION = SuperNEMOTokenizationConfig(
    tokenization="entity",
    max_tokens=512,
)
_PATCH_TOKENIZATION = SuperNEMOTokenizationConfig(
    tokenization="patch",
    max_tokens=512,
    patch_size_mm=88.0,
    patch_origin_mm=(-2816.0, -2816.0, -2816.0),
)
_SUMMARY_TOKENIZATION = SuperNEMOTokenizationConfig(
...
ARCHITECTURES: dict[str, ArchitectureConfig] = {
    ...
    "transformer_001_entity_coordinate_mlp": ArchitectureConfig(
        architecture_id="transformer_001_entity_coordinate_mlp",
        model_name="SuperNEMOTransformerClassifier",
        input_kind="sequence",
        model={
        ...
        tokenization=_ENTITY_TOKENIZATION,
    ),
    "transformer_002_patch_88mm_coordinate_mlp": ArchitectureConfig(
        architecture_id="transformer_002_patch_88mm_coordinate_mlp",
        model_name="SuperNEMOTransformerClassifier",
        input_kind="sequence",
        model={
            "position_encoding": "coordinate_mlp",
        ...
        tasks=("classification",),
        tokenization=_PATCH_TOKENIZATION,
    ),
    "transformer_003_patch_88mm_fourier_xyz": ArchitectureConfig(
        architecture_id="transformer_003_patch_88mm_fourier_xyz",
        model_name="SuperNEMOTransformerClassifier",
        input_kind="sequence",
        model={
    ...
    "transformer_004_entity_fourier_xyz": ArchitectureConfig(
        architecture_id="transformer_004_entity_fourier_xyz",
        model_name="SuperNEMOTransformerClassifier",
        input_kind="sequence",
        model={
            "position_encoding": "fourier_xyz",
    ...
    "transformer_005_summary_16_coordinate_mlp": ArchitectureConfig(
        architecture_id="transformer_005_summary_16_coordinate_mlp",
        model_name="SuperNEMOTransformerClassifier",
        input_kind="sequence",
        model={
            "position_encoding": "coordinate_mlp",
        ...
        tasks=("classification",),
        tokenization=_SUMMARY_TOKENIZATION,
    ),
    "transformer_006_summary_16_fourier_xyz": ArchitectureConfig(
        architecture_id="transformer_006_summary_16_fourier_xyz",
        model_name="SuperNEMOTransformerClassifier",
        input_kind="sequence",
        model={
            "position_encoding": "fourier_xyz",
...
for _architecture in ARCHITECTURES.values():
    ...
    if _architecture.tokenization is None:
        ...
        if (
            _architecture.model_name != "SuperNEMOTransformerClassifier"
