...
This detector folder is the standardized, collaborator-facing workflow for
...
The table above records the completed reference run. Generated result folders
and predictions are intentionally excluded from the public workflow.
